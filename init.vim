...
"" Conceal cursor settings
"" don't hide markdown elements (doesn't work yet)
set cole=0
...
" Code actions can be performed on the word under the cursor
